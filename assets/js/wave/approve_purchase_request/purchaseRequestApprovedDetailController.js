app.controller('PurchaseRequestApprovedDetailController', function($filter, $scope, $http, $modal, $stateParams, $rootScope, PurchaseService, VendorService, WarehouseService, SweetAlert) {
