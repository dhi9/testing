app.controller('InventoryReportController', function($filter, $scope, $http, ngTableParams, InventoryService, CategoryFactory, ItemService, ItemFactory, SiteService) {
