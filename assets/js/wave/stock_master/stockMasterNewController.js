app.controller('StockMasterNewController', function($scope, $modal, $state, ItemService, SweetAlert, CategoryFactory) {
	$scope.item = {};
	...
	$scope.insertItem = function () {
		ItemService.insertItem($scope.item).success(function(data){
