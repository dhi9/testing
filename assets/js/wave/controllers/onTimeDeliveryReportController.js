app.controller('OnTimeDeliveryReportController', function($scope, $filter, ApiCallService, ngTableParams) {
	...
	$scope.applySearch = function(){
		...
		ApiCallService.getOnTimeDeliveryReport($scope.search).
	...
	$scope.exportToCSV = function() {
		var now = new Date();
		var filename = "otdreport" + moment(now).format('YYYYMMDDhhmmss');
