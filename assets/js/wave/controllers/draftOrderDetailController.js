app.controller('DraftOrderDetailController', function($scope, $modal, ItemLookupService, ApiCallService, CustomerService, SweetAlert, $state, AuthService, $stateParams) {
	...
	$scope.insertDraftOrder = function() {
		...
		if ($scope.isCustomerValid() && $scope.isOrderItemsValid()) {
			var inputOrder = {};
			...
			ApiCallService.insertDraftOrder(inputOrder).
				success(function(data, status, headers, config) {
					...
					if (data.call_status === "success") {
						SweetAlert.swal("Tambah Draft Order Berhasil", "Draft order telah disimpan.", "success");
			...
			SweetAlert.swal({
				title: "Perhatian!",
				text: "Customer atau Order Barang tidak boleh kosong", 
				type: "warning", 
				//confirmButtonColor: "#DD6B55",
				confirmButtonText: "Ok",
				closeOnConfirm: true,
