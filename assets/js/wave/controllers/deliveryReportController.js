app.controller('DeliveryReportController', function($scope, $filter, ApiCallService, ngTableParams) {
	...
	$scope.applySearch = function(){
		...
		ApiCallService.getDeliveryReport($scope.search).
	...
	$scope.exportToCSV = function() {
		var now = new Date();
		var filename = "reportpengiriman" + moment(now).format('YYYYMMDDhhmmss');
