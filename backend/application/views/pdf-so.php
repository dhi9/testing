<html>
     <head lang="en">
          <meta charset="UTF-8">
          <title><?php echo $ActiveCompanyDetail->order_so_name ?></title>
          <style>
         ...
         <table id="collapse" style="border:1px solid #000;border-collapse:collapse;">
            <tr>
                ...
                <td rowspan="2" class="w50" style="border-right:1px solid #000;border-bottom:1px solid #000;">
                    Service Order  : <?php echo $ActiveRequestDetail['requests_reference'] ?>
                    <barcode code="<?php echo $ActiveRequestDetail['requests_reference'] ?>" type="C128A" height="0.66" text="2" />
                </td>
                <td class="w25" style="border-right:1px solid #000;border-bottom:1px solid #000;">SO Date: <?php echo date("Y-m-d",strtotime($ActiveRequestDetail['date_created'])); ?></td>
            </tr>
             <tr>
                <td style="border-right:1px solid #000;border-bottom:1px solid #000;">Page: 1 of 1</td>
             </tr>
             <tr>
            ...
            <thead>
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $key['service_name'];$i+=1 ?></td>
