...
class Sales_db extends CI_Model {
	...
	public function get_sales_by_delivery_id($delivery_id)
	{
		return $this->db
			->select('o.*')
			->from('orders as o')
			->join('delivery as d', 'd.order_id = o.order_id')
	...
	{
		$column_list = ["order_id", "item_code", "length", "width", "height", "quantity", "material_type", "remark", "child_items"];
